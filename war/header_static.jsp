<%@page language="java" buffer="64kb" pageEncoding="UTF-8"%><%final boolean isWebkit = ServletUtils.isWebKitDevice(request); if (!isWebkit) {%><?xml version="1.0" encoding="utf-8"?><% } %>
